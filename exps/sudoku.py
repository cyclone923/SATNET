...
class SudokuSolver(nn.Module):
    def __init__(self, boardSz, aux, m, top_k):
...
def main():
    ...
    parser.add_argument('--testBatchSz', type=int, default=1)
    ...
    save = 'sudoku{}.boardSz{}-aux{}-m{}-lr{}-bsz{}'.format(
            '.perm' if args.perm else '', args.boardSz, args.aux, args.m, args.lr, args.batchSz)
    if args.save:
    ...
    model = SudokuSolver(args.boardSz, args.aux, args.m, args.top_k)
